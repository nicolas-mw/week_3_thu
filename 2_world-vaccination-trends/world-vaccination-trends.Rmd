...
world_vaccination <- read_csv("2_world-vaccination-trends/data/world_vaccination.csv")
world_vaccination_filtered <- world_vaccination %>% 
...
world_vacc_plot = world_vaccination %>% 
  ...
  geom_point()+
  labs(y = "Percentage of people vaccinated", x= " Year", color = "WHO region")
...
world_vaccination %>% 
  ...
  geom_point()+
  labs(y = "Percentage of people vaccinated", x= " Year", colour = "Vaccine", shape = "Vaccine")
